...
class EmployeeType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('tss', IntegerType::class, [
                'label' => 'TSS en secondes',
                'required' => false,
                'attr' => ['class' => 'form-control']
            ])
            ->add('lastTss', IntegerType::class, [
                'label' => 'Dernier TSS en secondes',
                'required' => false,
                'attr' => ['class' => 'form-control']
            ])
            ->add('totalTss', IntegerType::class, [
                'label' => 'Total TSS en secondes',
                'required' => false,
                'attr' => ['class' => 'form-control']
            ])
